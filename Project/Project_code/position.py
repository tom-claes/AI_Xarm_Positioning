...
if arm.error_code == 0 and not params['quit']:
    code = arm.reset()
    #1
    code = arm.set_position(*[425.0, 0.0, 400.0, 180.0, 0.0, 0.0], speed=params['speed'], mvacc=params['acc'], radius=-1.0, wait=True)
    time.sleep(1)
    #2
    code = arm.set_position(*[0.0, 405.0, 400.0, 180.0, 0.0, 0.0], speed=params['speed'], mvacc=params['acc'], radius=-1.0, wait=True)
    time.sleep(1)
