...
if arm.error_code == 0 and not params['quit']:
    code = arm.reset()
    code = arm.set_position(*[350.0, 0.0, 120.5, 180.0, 0.0, 0.0], speed=params['speed'], mvacc=params['acc'], radius=-1.0, wait=True)
    time.sleep(1)
    code = arm.set_position(*[350.0, 400, 120.5, 180.0, 0.0, 0.0], speed=params['speed'], mvacc=params['acc'], radius=-1.0, wait=True)    
    time.sleep(1)
    code = arm.set_position(*[350.0, -400, 120.5, 180.0, 0.0, 0.0], speed=params['speed'], mvacc=params['acc'], radius=-1.0, wait=True)    
    time.sleep(1)
    code = arm.set_position(*[-350.0, -400, 120.5, 180.0, 0.0, 0.0], speed=params['speed'], mvacc=params['acc'], radius=-1.0, wait=True)    
